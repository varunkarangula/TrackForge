...
import { LayoutDashboard, User, Mail, Lock, Sun, Moon, ArrowRight, Eye, EyeOff } from 'lucide-react';
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-sm space-y-6 animate-fade-in">
          <div className="text-center space-y-1">
            ...
            <p className="text-sm text-zinc-500 dark:text-zinc-400">Start tracking your finances and tasks</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" placeholder="John Doe" value={name} onChange={e => setName(e.target.value)} required className="input pl-9" />
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                />
                <button type="button" onClick={() => setShowPassword(s => !s)} className="absolute right-3 top-1/2 -translate-y-1/2 text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-200 transition-colors">
          ...
          <p className="text-center text-sm text-zinc-500 dark:text-zinc-400">
            ...
            <Link to="/login" className="font-medium text-primary hover:text-primaryDark transition-colors">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
